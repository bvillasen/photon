...
def load_snapshot_data_distributed( data_type, fields,  nSnap, inDir,  box_size, grid_size,  precision, subgrid=None, proc_grid=None, print_out=True, get_statistics=False, print_fields=False ):
  ...
  for field in fields:
    ...
    for i, nBox in enumerate(ids_to_load):
      ...
      if not data_particels:
        ...
        data_local = inFile[field][...].astype(precision)
